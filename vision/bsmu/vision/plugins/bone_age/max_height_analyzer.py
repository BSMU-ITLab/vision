...
class MaxHeightAnalyzer:
    MALE_PREMATURE_BONE_GROWTH_FACTOR_REGRESSION_COEFFS = [
    ...
    MALE_NORMAL_BONE_GROWTH_FACTOR_REGRESSION_COEFFS = [
    ...
    MALE_SLOW_BONE_GROWTH_FACTOR_REGRESSION_COEFFS = [
    ...
    FEMALE_PREMATURE_BONE_GROWTH_FACTOR_REGRESSION_COEFFS = [
    ...
    FEMALE_NORMAL_BONE_GROWTH_FACTOR_REGRESSION_COEFFS = [
    ...
    def male_premature_bone_growth_factor(bone_age: float) -> float:
        return regression(bone_age, MaxHeightAnalyzer.MALE_PREMATURE_BONE_GROWTH_FACTOR_REGRESSION_COEFFS)

    @staticmethod
    def male_normal_bone_growth_factor(bone_age: float) -> float:
        return regression(bone_age, MaxHeightAnalyzer.MALE_NORMAL_BONE_GROWTH_FACTOR_REGRESSION_COEFFS)

    @staticmethod
    def male_slow_bone_growth_factor(bone_age: float) -> float:
        return regression(bone_age, MaxHeightAnalyzer.MALE_SLOW_BONE_GROWTH_FACTOR_REGRESSION_COEFFS)

    @staticmethod
    def female_premature_bone_growth_factor(bone_age: float) -> float:
        return regression(bone_age, MaxHeightAnalyzer.FEMALE_PREMATURE_BONE_GROWTH_FACTOR_REGRESSION_COEFFS)

    @staticmethod
    def female_normal_bone_growth_factor(bone_age: float) -> float:
        return regression(bone_age, MaxHeightAnalyzer.FEMALE_NORMAL_BONE_GROWTH_FACTOR_REGRESSION_COEFFS)
