...
from PySide6.QtCore import Qt, QObject, QEvent, QElapsedTimer
from PySide6.QtGui import QActionGroup

from bsmu.vision.core.plugins.observer import ObserverPlugin
from bsmu.vision.plugins.tools.viewer.base import ViewerToolPlugin
from bsmu.vision.plugins.windows.main import ToolsMenu

if TYPE_CHECKING:
    from bsmu.vision.plugins.windows.main import MainWindowPlugin, MainWindow
    from bsmu.vision.plugins.tools.viewer.base import MdiViewerTool
...
class ViewerToolManagerPlugin(ObserverPlugin):
    ...
    def _enable_gui(self):
        ...
        self._main_window.installEventFilter(self._viewer_tool_manager)
