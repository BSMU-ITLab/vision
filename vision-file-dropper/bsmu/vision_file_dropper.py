...
class FileDropperPlugin(Plugin):
    def __init__(self, app: App):
        ...
        self.mdi = app.enable_plugin('bsmu.vision_mdi.MdiPlugin').mdi
        file_loading_manager_plugin = app.enable_plugin('bsmu.vision_file_loading_manager.FileLoadingManagerPlugin')

        self.file_dropper = MdiFileDropper(file_loading_manager_plugin.file_loading_manager,
